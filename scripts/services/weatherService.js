...
function owmIconFromCode(id, isDay) {
  ...
  // Group 5xx: Rain
  if (id === 511) return 'snow';                                        // freezing rain → snow icon
  ...
  if (id === 771) return 'storm';                                       // squalls
  if (id === 781) return 'storm';                                       // tornado
...
// ---- OWM condition code → human-readable condition text -----------------
// Matches the condition strings used in weatherConditions.js for translation
function owmConditionText(id) {
  switch (id) {
    // Group 2xx: Thunderstorm
    case 200: case 201: case 202: case 211: case 212:
    case 221: case 230: case 231: case 232: return 'Thunderstorm';
    case 210: return 'Thunder';

    // Group 3xx: Drizzle
    case 300: case 310: return 'Light Drizzle';
    case 301: case 311: case 321: return 'Drizzle';
    case 302: case 312: case 314: return 'Heavy Drizzle';
    case 313: return 'Showers';

    // Group 5xx: Rain
    case 500: return 'Light Rain';
    case 501: return 'Rain';
    case 502: case 503: case 504: return 'Heavy Rain';
    case 511: return 'Freezing Rain';
    case 520: case 521: case 522: case 531: return 'Showers';

    // Group 6xx: Snow
    case 600: case 620: return 'Light Snow';
    case 601: case 621: return 'Snow';
    case 602: case 622: return 'Heavy Snow';
    case 611: case 612: case 613: return 'Sleet';
    case 615: case 616: return 'Rain';

    // Group 7xx: Atmosphere
    case 701: return 'Mist';
    case 711: return 'Smoke';
    case 721: return 'Haze';
    case 731: case 751: case 761: return 'Dust';
    case 741: case 762: return 'Fog';
    case 771: return 'Squalls';
    case 781: return 'Storm';

    // Group 800: Clear
    case 800: return 'Clear';

    // Group 80x: Clouds
    case 801: case 802: return 'Partially cloudy';
    case 803: case 804: return 'Overcast';
